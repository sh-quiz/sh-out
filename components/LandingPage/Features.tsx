...
export default function Features() {
    return (
        <section className="py-32 px-4 bg-[#0B0E12] relative z-10">
            <div className="max-w-7xl mx-auto">
                <div className="mb-24">
                    <h2 className="text-6xl md:text-8xl font-black text-[#E8E9EA] mb-6 tracking-tighter">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {features.map((feature, i) => (
                        <motion.div
                            ...
                            className={cn(
                                "group relative p-8 md:p-12 min-h-[300px] border border-[#E8E9EA]/5 hover:border-[#FF2D55]/30 transition-colors duration-500 overflow-hidden",
                                feature.colSpan,
                                feature.bg
                            )}
                        >
                            <div className="relative z-10 h-full flex flex-col justify-end">
                                <h3 className="text-3xl font-bold mb-4 text-[#E8E9EA] group-hover:text-[#FF2D55] transition-colors">
                                    {feature.title}
                                </h3>
                                <p className="text-[#E8E9EA]/60 text-lg">
                                    {feature.description}
                                </p>
                            </div>
