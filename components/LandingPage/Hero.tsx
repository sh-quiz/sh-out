    ...
    return (
        <section className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center bg-[#0B0E12]">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 w-full max-w-[1400px]">
                ...
                >
                    <Link href="/auth" className="group relative px-8 py-4 md:px-12 md:py-6 bg-[#FF2D55] text-white text-lg md:text-xl font-bold tracking-wider uppercase overflow-hidden transition-all hover:scale-105 active:scale-95 inline-block">
