  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-blue-500/30 relative overflow-hidden flex flex-col items-center justify-center">
      ...
      <main className="relative z-10 w-full max-w-md px-6 flex flex-col items-center">
        ...
        <form className="w-full space-y-2 mb-4" onSubmit={handleLogin}>
          {error && (
            <motion.div
        ...
        <div className="w-full flex items-center gap-4 mb-6">
          ...
          <span className="text-[#878D96] text-xs uppercase tracking-widest">or</span>
          <div className="flex-1 h-[1px] bg-white/10" />
        </div>
        ...
        <motion.button
          ...
          className="w-full h-14 mb-8 bg-white text-black font-semibold rounded-full transition-all flex items-center justify-center gap-3 hover:bg-gray-100"
        >
